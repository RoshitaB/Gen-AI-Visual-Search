...
def fetch_s3_images(request):
    ...
    AWS_ACCESS_KEY_ID = 'AKIA6FHPZ5V2T2NIO6NP'
    AWS_SECRET_ACCESS_KEY = '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'
    AWS_STORAGE_BUCKET_NAME = 'django-raka'
    AWS_S3_REGION_NAME = 'us-east-1'
    AWS_S3_ENDPOINT_URL = 's3://django-raka/final_images/'
